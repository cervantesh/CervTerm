...
- Bounded pane-local OSC 133/633 prompt, command-input, and command-output metadata that preserves the 32-byte cell budget through wide cells, scrollback, reflow, resize, reset, and alternate screens without retaining shell command/property payloads.
