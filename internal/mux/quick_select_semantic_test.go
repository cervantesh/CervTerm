...
func TestQuickSelectSnapshotDetachesSemanticZones(t *testing.T) {
	...
	if core.SemanticCellKind(snapshot.Cells[0]) != core.SemanticPrompt || core.SemanticCellKind(snapshot.Cells[1]) != core.SemanticInput {
	...
	if core.SemanticCellKind(again.Cells[0]) != core.SemanticPrompt || again.SemanticZones[0].Kind != core.SemanticPrompt {
