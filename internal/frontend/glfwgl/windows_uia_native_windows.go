...
var (
	...
	uiaRaiseAutomationEvent   = uiaAutomationCore.NewProc("UiaRaiseAutomationEvent")
	uiaRaiseNotificationEvent = uiaAutomationCore.NewProc("UiaRaiseNotificationEvent")
	uiaRaiseStructureEvent    = uiaAutomationCore.NewProc("UiaRaiseStructureChangedEvent")
	uiaClientsListeningProc   = uiaAutomationCore.NewProc("UiaClientsAreListening")
