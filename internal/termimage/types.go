...
var (
	...
	ErrWrongOwner          = errors.New("termimage wrong store owner capability")
	ErrWrongOwnerThread    = errors.New("termimage store owner called from another native thread")
	ErrStaleOwner          = errors.New("termimage stale store owner generation")
	ErrOwnerBusy           = errors.New("termimage store owner mutation already active")
	ErrStaleMutationScope  = errors.New("termimage store mutation scope is not active")
)
